        ...
        static void Main(string[] args)
        {
            ...
            else if(roomChoice == "dining room")
            {
                ...
                else if(vaseChoice == "no")
                {
                    ...
                    Console.WriteLine("As you turn to leave you hear a cracking sound soming from the corner.");
                    
                    Console.WriteLine("A dark figure with glowing red eyes launches at you, knocking you unconcious.");
                    Console.WriteLine("You wake up in your bed. It was all a dream.... Or was it?");
                }
                else
                {
